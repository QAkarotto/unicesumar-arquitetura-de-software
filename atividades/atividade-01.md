# Atividade 01: Adicionar nome na lista de alunos no repositório da disciplina (individual)
...
> https://github.com/QAkarotto/unicesumar-arquitetura-de-software
...
```bash
git clone https://github.com/QAkarotto/unicesumar-arquitetura-de-software.git
```
